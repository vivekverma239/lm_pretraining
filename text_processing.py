...
def text_to_word_sequence(text,
    ...
    if not custom_tokenizer_function:
        if sys.version_info < (3,):
        ...
        seq = custom_tokenizer_function(text)
...
class Tokenizer(object):
    ...
    def __init__(self, num_words=None,
        ...
        self.custom_tokenizer_function = custom_tokenizer_function
        ...
        for text in texts:
            ...
            if self.char_level or isinstance(text, list):
                ...
                seq = text_to_word_sequence(text,
                                            ...
                                            self.lower,
                                            self.split,
                                            self.custom_tokenizer_function)
            for w in seq:
