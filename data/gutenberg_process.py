...
save_path = 'data/'
LM_TRAIN_FILE = 'lm_gutenberg_train.txt'
LM_VAL_FILE = 'lm_gutenberg_val.txt'
...
def process_data_for_language_model(val_sample=5000, tokenizer=None):
    ...
    test_text = [open(i, encoding='utf-8', errors='ignore').read() for i in test_files  ]
    train_text = [open(i, encoding='utf-8', errors='ignore').read() for i in train_files  ]
